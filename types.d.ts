...
export declare const InterviewMode: {
    readonly VIDEO: "Video Interview";
    readonly AUDIO: "Audio Interview";
    readonly CHAT: "Chat Interview";
    readonly LIVE_SHARE: "Live Share Interview";
};
