...
import type { InterviewSettings, ModelSettings, Job, InterviewDifficulty, User, TInterviewMode, Language } from '../types';
import { InterviewMode as InterviewModeEnum } from '../types';
import { getJobs, getLanguages } from '../supabaseService';
import { PencilIcon, TargetIcon, BriefcaseIcon, GlobeIcon, SignalIcon } from '../constants';
...
import { TRENDING_JOBS_DATA } from '../constants';
